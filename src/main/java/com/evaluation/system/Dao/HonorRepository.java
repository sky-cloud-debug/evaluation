...
public interface HonorRepository extends JpaRepository<honor,String> {
    ...
    @Query(value = "select new com.evaluation.system.domain.ExtraEntity.VerifyHonor(a.number,b.name,b.classMajor,a.studentHonor,a.year,a.state,a.reason) from honor a,basic b where a.number=b.number and b.classMajor=?1 and a.state=?2")
